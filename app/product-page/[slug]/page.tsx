      ...
      <section className="max-w-7xl w-full bg-white p-10 rounded-3xl flex flex-col lg:flex-row justify-center gap-16 lg:gap-24">
        ...
        <figure className="flex-1 flex justify-center">
          <div className="relative w-full max-w-xl aspect-square rounded-3xl overflow-hidden border border-gray-200">
            <Image
              src={
                product.product_images[0].image_url || "/placeholder-image.png"
              }
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="w-10 h-10 rounded-full bg-blue-500 border-2 border-gray-300 hover:scale-105 transition-all cursor-pointer"
              ></button>
              <button
                aria-label="Select black color"
                className="w-10 h-10 rounded-full bg-orange-400 border-2 border-gray-300 hover:scale-105 transition-all cursor-pointer"
              ></button>
              <button
                aria-label="Select pink color"
                className="w-10 h-10 rounded-full bg-red-200 border-2 border-gray-300 hover:scale-105 transition-all cursor-pointer"
              ></button>
            </div>
          </div>
